...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let disabledDates = <?php echo json_encode($reservations, 15, 512) ?> ? <?php echo json_encode($reservations, 15, 512) ?>.map(res => ({
            from: res.start_date,
            to: res.end_date
        })) : [];
...
<?php /**PATH C:\Users\hp\Desktop\TA\yc-touristay-2\resources\views/components/reservation_modal.blade.php ENDPATH**/ ?>