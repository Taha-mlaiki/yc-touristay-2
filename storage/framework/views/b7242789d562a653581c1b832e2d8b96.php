    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; padding: 20px; border: 1px solid #e5e7eb; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td width="50%" style="text-align: right; padding-bottom: 15px;">
                <p style="font-size: 14px; color: #4b5563; margin: 0;">Issued on: <?php echo e(\Carbon\Carbon::now()->format('F j, Y')); ?></p>
                <p style="font-size: 14px; font-weight: bold; color: #1f2937; margin: 5px 0 0 0;">Reservation ID: #<?php echo e($details["reservation_id"]); ?></p>
            </td>
        </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td width="50%" style="padding-right: 15px;">
                            ...
                            <p style="font-size: 14px; color: #4b5563; margin: 0;"><span style="font-weight: bold;">Property Name:</span> <?php echo e($details["property_title"]); ?></p>
                        </td>
                        <td width="50%">
                            <h2 style="font-size: 18px; font-weight: bold; color: #374151; margin: 0 0 5px 0;">Guest Details</h2>
                            <p style="font-size: 14px; color: #4b5563; margin: 0;"><span style="font-weight: bold;">Guest Name:</span> <?php echo e($details["name"]); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <td width="50%" style="padding-right: 15px; padding-top: 10px;">
                            <p style="font-size: 14px; color: #4b5563; margin: 0;"><span style="font-weight: bold;">Check-in Date:</span> <?php echo e($details["start_date"]); ?></p>
                            <p style="font-size: 14px; color: #4b5563; margin: 5px 0 0 0;"><span style="font-weight: bold;">Check-out Date:</span> <?php echo e($details["end_date"]); ?></p>
                        </td>
                        <td width="50%" style="padding-top: 10px;">
                            <p style="font-size: 14px; color: #4b5563; margin: 0;"><span style="font-weight: bold;">Total Price:</span> <?php echo e($details["end_date"]); ?></p>
