    ...
    <div class="container mx-auto px-4 mb-20">
        ...
        <div class="flex flex-col md:flex-row md:items-start justify-between mb-12">
            <div class="w-full md:w-2/3">
                ...
                <h1 class="text-3xl md:text-5xl font-bold text-gray-800 mb-4 leading-tight"><?php echo e($announcement->title); ?>
                ...
                <div class="flex items-center text-gray-500 mb-6">
                    ...
                    <span><?php echo e($announcement->address); ?></span>
                </div>
                <p class="text-gray-600 text-lg leading-relaxed"><?php echo e($announcement->description); ?></p>
            </div>

            <div class="w-full md:w-1/3 mt-8 md:mt-0 md:pl-8">
                <?php if(Auth::user()->id == $announcement->user_id): ?>
                ...
                <div class="bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl shadow-xl overflow-hidden">
                    <div class="p-6">
                        <div class="flex items-baseline">
                            <span
                                class="text-white text-4xl font-bold">$<?php echo e(number_format($announcement->price)); ?></span>
                        </div>
...
<?php $attributes = $__attributesOriginalf437511b3f5ffb0343414062d24e6891; ?>
<?php unset($__attributesOriginalf437511b3f5ffb0343414062d24e6891); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf437511b3f5ffb0343414062d24e6891)): ?>
<?php $component = $__componentOriginalf437511b3f5ffb0343414062d24e6891; ?>
<?php unset($__componentOriginalf437511b3f5ffb0343414062d24e6891); ?>
<?php endif; ?>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-800"><?php echo e($announcement->type); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-800"><?php echo e(number_format($announcement->sqft)); ?> sqft
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-800"><?php echo e($announcement->Beds); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-800"><?php echo e($announcement->Baths); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Desktop\TA\yc-touristay-2\resources\views/announcement_details.blade.php ENDPATH**/ ?>