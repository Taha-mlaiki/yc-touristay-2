...
<?php endif; ?>
        ...
        <div>
            <a class="underline text-sm mt-3 text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                href="<?php echo e(route('register')); ?>">Don't have an account</a>
        </div>
    </form>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Desktop\TA\yc-touristay-2\resources\views/auth/login.blade.php ENDPATH**/ ?>